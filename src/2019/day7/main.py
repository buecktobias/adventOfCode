# Created by Tobias Bück at 2019-12-07 06:51:59.684845
# Solution of day 7 of advent of Code 2019
# 
# INPUTS
import subprocess
...
def get_input_file():
    return open("../../../input/2019/input7.txt")
...
def run_amplifier(numbers, phase_setting, input_signal):
    amplifier = InputParser(numbers)
    amplifier.start()
    make_input(phase_setting + "\n" + input_signal)
